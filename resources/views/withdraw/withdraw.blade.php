    ...
    <div class="py-6 px-6">
        <div class="flex justify-center md:p-4 p-6 md:max-w-md max-w-lg mx-auto bg-white rounded-xl shadow-md flex items-center space-x-4">
            <div class="py-4 px-4 flex flex-col">
                <span class="md:text-2xl text-xl md:flex md:justify-center font-bold">Withdraw</span>
            ...
            <!-- 5% > 50,000 -->
                ...
                <form action="{{ route('withdraw') }}" method="POST" class="">
                    @csrf
                    <div class="pt-6">
                        <input type="text" name="amount" value="{{ old('amount') }}" class="@error('amount') ring-red-500 text-white @enderror rounded-lg p-4 ring ring-gray-100 ring-offset-0 w-full h-8 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Amount" />
